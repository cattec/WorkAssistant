...
import com.example.workassistant.databinding.ActivityMainBinding
import com.example.workassistant.databinding.ChannelsListBinding
...
class ChannelsListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            findViewById<ChannelsView>(R.id.channelsView).setOnChannelClickListener { channel ->
